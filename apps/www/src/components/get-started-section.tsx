    ...
    <section className="p-2">
      ...
      <div className="mt-4">
        <div className="text-center">
          <Button asChild size="lg" className="mb-4 md:mr-4">
        ...
        <Tabs defaultValue="npm" className="w-full">
          <TabsList className="grid w-full grid-cols-2 md:grid-cols-3">
            ...
            <TabsTrigger disabled value="ios" className="hidden sm:flex">
              Install iOS 🔜
            </TabsTrigger>
          </TabsList>
          <>
            <TabsContent value="npm">
              <div className="rounded-lg border p-6 space-y-4">
                ...
                <pre className="bg-muted overflow-x-auto rounded-md p-4 text-sm">
                  <code className="whitespace-pre language-json">
    ...
    // ...
            ...
            <TabsContent value="maven">
              <div className="rounded-lg border p-6 space-y-4">
                ...
                <pre className="bg-muted overflow-x-auto rounded-md p-4 text-sm">
                  <code className="whitespace-pre language-kotlin">

...
export const SurfaceField = () => {
    ...
    return (
        <div className='grid gap-4'>
                        ...
                        <Controller
                            ...
                            render={({ field }) => (
                                <>
                                    ...
                                    <Input {...field} type="number" step="1" placeholder="Border Radius" />
                                </>
                            )}
                        />
                        <Controller
                            ...
                            render={({ field }) => (
                                <>
                                    ...
                                    <Input {...field} type="number" step="1" placeholder="Border Width" />
                                </>
                            )}
                        />
                        <Controller
            ...
            <Button type="button" onClick={() => append({ name: '', description: '', borderColor: '', borderRadius: 0, borderWidth: 0, boxShadow: '', backgroundColor: '' })}>Add Surface</Button>
        </div>
    );
};

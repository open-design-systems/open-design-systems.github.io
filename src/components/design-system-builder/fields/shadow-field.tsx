...
export const ShadowsField = () => {
    ...
    return (
        <div className='grid gap-4'>
                        ...
                        <Controller
                            ...
                            render={({ field }) => (
                                <>
                                    ...
                                    <Input {...field} type="number" step="0.01" placeholder="Shadow Opacity" />
                                </>
                            )}
                        />
                        ...
                        <Controller
                            ...
                            render={({ field }) => (
                                <>
                                    ...
                                    <Input {...field} type="number" step="0.1" placeholder="Shadow Radius" />
                                </>
                            )}
                        />
                    </div>
            ...
            <Button type="button" onClick={() => append({ meta: { name: '', description: '' }, elevation: '', shadowColor: '', shadowOpacity: 1, shadowOffset: { width: 0, height: 0 }, shadowRadius: 0 })}>Add Shadow</Button>
        </div>
    );
};
